...
class CommandResult:
    ...
    def _repr_html_(self) -> str:
        ...
        <div style="border: 1px solid #ddd; border-radius: 8px; padding: 15px; margin: 10px 0; font-family: 'Monaco', 'Menlo', 'Ubuntu Mono', monospace; background-color: #f8f9fa;">
            ...
            <details style="margin-bottom: 10px;">
                <summary style="cursor: pointer; font-weight: bold; color: #0066cc;">📤 Standard Output ({len(self.stdout.splitlines())} lines)</summary>
            ...
            <details style="margin-bottom: 10px;">
                <summary style="cursor: pointer; font-weight: bold; color: #cc6600;">📥 Standard Error ({len(self.stderr.splitlines())} lines)</summary>
    ...
    def __repr__(self) -> str:
        ...
        return f"CommandResult(exitCode={self.exitCode}, stdout_lines={len(self.stdout.splitlines())}, stderr_lines={len(self.stderr.splitlines())})"
